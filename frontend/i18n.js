const TRANSLATIONS = {
  en: {
    ...
    ghostTitle:         'Double-click to add this day',
    tapToAddDay:        'Tap to add this day',
    deleteColConfirm:   'Delete column and all its tasks?',
    deleteColHasTasks:  'Remove all tasks before deleting this column.',
    invalidDate:        'Enter a valid date as MM/DD or MM/DD/YYYY.',
    dayFallback:        'Day',
    dayLocale:          'en-US',
    scaleLarger:        'Larger',
    scaleSmaller:       'Smaller',
    customLoad:         'progressive load',
    on:                 'ON',
    off:                'OFF',
    ...
    mobMoveTo:               'MOVE TO',
    mobMoveToday:            'Today',
    mobTomorrow:             'Tomorrow',
    mobInAWeek:              'In a week',
    mobPickDate:             'or pick a date',
    mobMove:                 'Move',
    mobMovedTo:              'Moved to',
    mobMovedToLater:         'Moved to Later',
    mobUndo:                 'Undo',
  ...
  ru: {
    ...
    ghostTitle:         'Двойной клик — добавить этот день',
    tapToAddDay:        'Нажмите, чтобы добавить этот день',
    deleteColConfirm:   'Удалить колонку со всеми задачами?',
    deleteColHasTasks:  'Удалите все задачи перед удалением колонки.',
    invalidDate:        'Введите корректную дату в формате ММ/ДД или ММ/ДД/ГГГГ.',
    dayFallback:        'День',
    dayLocale:          'ru-RU',
    scaleLarger:        'Крупнее',
    scaleSmaller:       'Мельче',
    customLoad:         'прогрессивная загрузка',
    on:                 'ВКЛ',
    off:                'ВЫКЛ',
    earlierWeeks:       '↑ ранние недели',
    actAccount:         'Аккаунт',
    ...
    mobMoveToday:            'Сегодня',
    mobTomorrow:             'Завтра',
    mobInAWeek:              'Через неделю',
    mobPickDate:             'или выбери дату',
    mobMove:                 'Переместить',
    mobMovedTo:              'Перемещено на',
    mobMovedToLater:         'Перемещено в «Позже»',
    mobUndo:                 'Отменить',
