const TRANSLATIONS = {
  en: {
    ...
    ctxMoveAlong:       '→ move along',
    ctxNoMoveAlong:     '→ don\'t move along',
    ...
    mobMoveAlong:            'Move along',
    mobNoMoveAlong:          'Don\'t move along',
    mobDelete:               'Delete',
  ...
  ru: {
    ...
    ctxMoveAlong:       '→ переносить',
    ctxNoMoveAlong:     '→ не переносить',
    ...
    mobMoveAlong:            'Переносить',
    mobNoMoveAlong:          'Не переносить',
    mobDelete:               'Удалить',
